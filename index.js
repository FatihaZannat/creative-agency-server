...
// Current
const uri = `mongodb+srv://Book-Life:${DB_PASSWORD}@cluster0.z8m97.mongodb.net/${DB_NAME}?retryWrites=true&w=majority`;
...
client.connect(err => {
  ...
  const bookCollection = client.db(DB_NAME).collection("book");
